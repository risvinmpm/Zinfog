...
const MostReview = () => {
  ...
  return (
    <div className="main-padding pb-10 lg:pb-20 xl:pb-30 bg-[#131321]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-14">
        ...
        <div>
          ...
          <p className="pt-7 pb-5 max-w-md text-gray-300">
            {description}
          </p>
          <div className="flex items-center gap-4 mt-4">
            ...
            />
            <div>
              <p className="text-[#3B5CFF] text-sm font-medium">{authorName}</p>
