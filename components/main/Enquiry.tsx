...
const Enquiry = () => {
  return (
    <section className="main-padding text-white">
          ...
          <div className="md:col-span-4 flex justify-center">
            <div className="flex flex-col justify-center gap-4 max-w-2xl py-10 px-4">
              ...
              <p className="text-base">
                You are at the right place to take your business to a different
                level, digitally. If you&apos;re looking for a perfect ERP solution
                or web development, connect with us right away!
              </p>
      ...
      {/* Newsletter Signup */}
      <div className="mt-10">
        <h4 className="mb-5 text-lg font-semibold">SIGN TO OUR NEWSLETTER:</h4>
