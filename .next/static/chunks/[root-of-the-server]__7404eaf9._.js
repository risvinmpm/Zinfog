...
(()=>{
    const e = new Error("Cannot find module '../../common/'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/utils/formatBlog'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
async function BlogListPage() {
    ...
    const blogs = data.slice(0, 9).map((item, i)=>formatBlog(item, i));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7404eaf9._.js.map